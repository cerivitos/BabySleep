...
(function () {
    ...
    const file = "src\\components\\SignIn.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(meta, file, 35, 13, 1033);
    			div.id = "my-signin2";
    			add_location(div, file, 38, 0, 1112);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	var signin = new SignIn({ $$inline: true });
    	...
    	return {
    		c: function create() {
    			...
    			add_location(main, file$1, 11, 0, 272);
    		},
