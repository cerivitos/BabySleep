...
(function () {
    ...
    // (54:2) {#if $signedInUser === undefined || $gAPIInstance !== undefined}
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			meta.name = "google-signin-client_id";
    			meta.content = meta_content_value = credentials.CLIENT_ID;
    			add_location(meta, file$1, 48, 2, 1350);
    			main.className = "overflow-hidden";
    			add_location(main, file$1, 51, 0, 1441);
    		},
          ...
          gapi.load("auth2", () => {
            gapi.auth2
              ...
              .then(result => {
                ...
                $$invalidate('googleAuth', googleAuth = result);
