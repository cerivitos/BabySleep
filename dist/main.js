...
(function () {
    ...
    */
    ...
    const file$1 = "src\\components\\EntryBlock.svelte";
    ...
    class EntryBlock extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment$1, safe_not_equal, ["date", "time", "title", "check", "minDate"]);
    ...
    // (224:0) <EntryBlock    title="Picked up at"    date={pickUpDate}    time={pickUpTime}    check="check4v3"    minDate={wakeDate}>
    function create_default_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$2, 230, 4, 6367);
    			div.className = "flex items-center justify-center";
    			add_location(div, file$2, 229, 2, 6315);
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			meta.name = "google-signin-client_id";
    			meta.content = meta_content_value = credentials.CLIENT_ID;
    			add_location(meta, file$3, 78, 2, 2552);
    			main.className = "overflow-hidden";
    			add_location(main, file$3, 81, 0, 2643);
    		},
