...
(function () {
    ...
    */
    ...
    const credentials = {
      ...
      API_KEY: "AIzaSyCRxUfwuIvlpcqDE6uuzqxw1EUiXFL3BAQ",
    ...
    const sheetName = writable(credentials.SPREADSHEET_ID);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			div2.className = div2_class_value = "background p-4 " + (ctx.isFocused ? 'background-selected' : '') + " svelte-15w8dxk";
    			add_location(div2, file, 23, 0, 860);
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((!current || changed.isFocused) && div2_class_value !== (div2_class_value = "background p-4 " + (ctx.isFocused ? 'background-selected' : '') + " svelte-15w8dxk")) {
     ...
     */
    function convertToDuration(mins) {
    ...
    /* src\components\LoadingSpinner.svelte generated by Svelte v3.4.0 */

    const file$1 = "src\\components\\LoadingSpinner.svelte";

    // (19:2) {#if text !== undefined}
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(body, file$1, 19, 4, 1415);
    		},
    ...
    function create_fragment$1(ctx) {
    	var div7, div6, div1, div0, t1, div3, div2, t3, div5, div4, t5;

    	var if_block = (ctx.text !== undefined) && create_if_block(ctx);
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div7, file$1, 6, 0, 1117);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$2, 500, 2, 15386);
    ...
    // (574:0) <EntryBlock    title="Picked up at"    date={pickUpDate}    time={pickUpTime}    check={check4v3}    minDate={wakeDate}    on:pickedupat={receivePickedUp}>
    function create_default_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button2, file$2, 595, 4, 18599);
    			div2.className = "flex items-center justify-center w-full";
    			add_location(div2, file$2, 594, 2, 18540);
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			...
    			if (!current || changed.nextPutDownTime) {
    				set_data(t2, ctx.nextPutDownTime);
    			}
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h2, file$4, 60, 6, 2054);
    			attr(path0, "id", "a");
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			h2.className = "svelte-13hyeae";
    			add_location(h2, file$4, 48, 6, 1626);
    			img.src = ctx.$userPic;
    			img.alt = "User profile picture";
    			img.className = "rounded-full w-8 h-8 mr-2 flex-none";
    			add_location(img, file$4, 50, 8, 1696);
    			body.className = "flex-1 svelte-13hyeae";
    			add_location(body, file$4, 54, 8, 1832);
    			button.className = "button svelte-13hyeae";
    			add_location(button, file$4, 55, 8, 1881);
    			div0.className = "flex items-center";
    			add_location(div0, file$4, 49, 6, 1655);
    			div1.className = "mt-2 flex-col";
    			add_location(div1, file$4, 47, 4, 1563);
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(body, file$4, 107, 8, 3701);
    			button.className = "button svelte-13hyeae";
    			add_location(button, file$4, 108, 8, 3760);
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div2, file$4, 118, 4, 4062);
    ...
    const file$6 = "src\\components\\Scaffold.svelte";
