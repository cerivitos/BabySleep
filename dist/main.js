...
(function () {
    ...
    */
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$2, 506, 2, 15575);
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$2, 528, 2, 16209);
    ...
    // (581:0) <EntryBlock    title="Picked up at"    date={pickUpDate}    time={pickUpTime}    check={check4v3}    minDate={wakeDate}    on:pickedupat={receivePickedUp}>
    function create_default_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button2, file$2, 602, 4, 18816);
    			div2.className = "flex items-center justify-center w-full";
    			add_location(div2, file$2, 601, 2, 18757);
    		...
    		p: function update(changed, ctx) {
    			if ((changed.isNap) && button0_class_value !== (button0_class_value = "nap-button rounded-l " + (ctx.isNap ? '' : 'inactive') + " svelte-15h91l6")) {
    				button0.className = button0_class_value;
    			}

    			if ((changed.isNap) && button1_class_value !== (button1_class_value = "nap-button rounded-r " + (!ctx.isNap ? '' : 'inactive') + " svelte-15h91l6")) {
