...
(function () {
    ...
    */
    ...
    // (301:0) <EntryBlock    title="Picked up at"    date={pickUpDate}    time={pickUpTime}    check={check4v3}    minDate={wakeDate}    on:pickedupat={receivePickedUp}>
    function create_default_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$1, 308, 4, 8271);
    			div.className = "flex items-center justify-center";
    			add_location(div, file$1, 307, 2, 8219);
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(meta, file$2, 111, 2, 2536);
    		},
    ...
    function create_fragment$3(ctx) {
    	var div8, div1, h20, t1, div0, img, t2, body0, t3, t4, button0, t6, div3, h21, t8, div2, body1, t10, button1, t12, div7, h22, t14, div4, body2, t16, input0, t17, body3, t19, input1, t20, body4, t22, div5, body5, t24, input2, t25, body6, t27, input3, t28, body7, t30, div6, body8, t32, input4, t33, body9, t35, input5, t36, body10, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			div3 = element("div");
    			h21 = element("h2");
    			h21.textContent = "Connected to";
    			t8 = space();
    			div2 = element("div");
    			body1 = element("body");
    			body1.textContent = "Hongjun's sleep log";
    			t10 = space();
    			...
    			div7 = element("div");
    			h22 = element("h2");
    			h22.textContent = "Intervals";
    			t14 = space();
    			div4 = element("div");
    			body2 = element("body");
    			body2.textContent = "Nap 1 to Nap 2";
    			t16 = space();
    			input0 = element("input");
    			t17 = space();
    			body3 = element("body");
    			body3.textContent = "hr";
    			t19 = space();
    			input1 = element("input");
    			t20 = space();
    			body4 = element("body");
    			body4.textContent = "min";
    			t22 = space();
    			div5 = element("div");
    			body5 = element("body");
    			body5.textContent = "Nap 2 to Nap 3";
    			t24 = space();
    			input2 = element("input");
    			t25 = space();
    			body6 = element("body");
    			body6.textContent = "hr";
    			t27 = space();
    			input3 = element("input");
    			t28 = space();
    			body7 = element("body");
    			body7.textContent = "min";
    			t30 = space();
    			div6 = element("div");
    			body8 = element("body");
    			body8.textContent = "Nap 3 to Sleep";
    			t32 = space();
    			input4 = element("input");
    			t33 = space();
    			body9 = element("body");
    			body9.textContent = "hr";
    			t35 = space();
    			input5 = element("input");
    			t36 = space();
    			body10 = element("body");
    			body10.textContent = "min";
    			h20.className = "svelte-z01q45";
    			add_location(h20, file$3, 109, 4, 3444);
    			img.src = ctx.$userPic;
    			img.alt = "User profile picture";
    			img.className = "rounded-full w-8 h-8 mr-2 flex-none";
    			add_location(img, file$3, 111, 6, 3510);
    			body0.className = "flex-1 font-bold svelte-z01q45";
    			add_location(body0, file$3, 115, 6, 3638);
    			button0.className = "button svelte-z01q45";
    			add_location(button0, file$3, 116, 6, 3695);
    			div0.className = "flex items-center";
    			add_location(div0, file$3, 110, 4, 3471);
    			div1.className = "mt-2 flex-col";
    			add_location(div1, file$3, 108, 2, 3411);
    			h21.className = "svelte-z01q45";
    			add_location(h21, file$3, 120, 4, 3794);
    			body1.className = "flex-1 font-bold svelte-z01q45";
    			add_location(body1, file$3, 122, 6, 3860);
    			button1.className = "button svelte-z01q45";
    			add_location(button1, file$3, 123, 6, 3925);
    			div2.className = "flex items-center";
    			add_location(div2, file$3, 121, 4, 3821);
    			div3.className = "mt-8 flex-col";
    			add_location(div3, file$3, 119, 2, 3761);
    			h22.className = "svelte-z01q45";
    			add_location(h22, file$3, 127, 4, 4020);
    			body2.className = "w-3/4 font-bold svelte-z01q45";
    			add_location(body2, file$3, 129, 6, 4070);
    			attr(input0, "type", "number");
    			input0.max = "3";
    			input0.min = "0";
    			input0.className = "input svelte-z01q45";
    			add_location(input0, file$3, 130, 6, 4129);
    			body3.className = "ml-1 mr-2 svelte-z01q45";
    			add_location(body3, file$3, 136, 6, 4261);
    			attr(input1, "type", "number");
    			input1.max = "59";
    			input1.min = "0";
    			input1.className = "input svelte-z01q45";
    			add_location(input1, file$3, 137, 6, 4302);
    			body4.className = "ml-1 svelte-z01q45";
    			add_location(body4, file$3, 143, 6, 4436);
    			div4.className = "flex";
    			add_location(div4, file$3, 128, 4, 4044);
    			body5.className = "w-3/4 font-bold svelte-z01q45";
    			add_location(body5, file$3, 146, 6, 4509);
    			attr(input2, "type", "number");
    			input2.max = "3";
    			input2.min = "0";
    			input2.className = "input svelte-z01q45";
    			add_location(input2, file$3, 147, 6, 4568);
    			body6.className = "ml-1 mr-2 svelte-z01q45";
    			add_location(body6, file$3, 153, 6, 4700);
    			attr(input3, "type", "number");
    			input3.max = "59";
    			input3.min = "0";
    			input3.className = "input svelte-z01q45";
    			add_location(input3, file$3, 154, 6, 4741);
    			body7.className = "ml-1 svelte-z01q45";
    			add_location(body7, file$3, 160, 6, 4875);
    			div5.className = "flex";
    			add_location(div5, file$3, 145, 4, 4483);
    			body8.className = "w-3/4 font-bold svelte-z01q45";
    			add_location(body8, file$3, 163, 6, 4953);
    			attr(input4, "type", "number");
    			input4.max = "3";
    			input4.min = "0";
    			input4.className = "input svelte-z01q45";
    			input4.id = "Nap3ToSleepHr";
    			add_location(input4, file$3, 164, 6, 5012);
    			body9.className = "ml-1 mr-2 svelte-z01q45";
    			add_location(body9, file$3, 171, 6, 5173);
    			attr(input5, "type", "number");
    			input5.max = "59";
    			input5.min = "0";
    			input5.className = "input svelte-z01q45";
    			add_location(input5, file$3, 172, 6, 5214);
    			body10.className = "ml-1 svelte-z01q45";
    			add_location(body10, file$3, 178, 6, 5349);
    			div6.className = "flex pb-8";
    			add_location(div6, file$3, 162, 4, 4922);
    			div7.className = "mt-8 flex-col";
    			add_location(div7, file$3, 126, 2, 3987);
    			div8.className = "w-full bg-backgroundColor p-4";
    			add_location(div8, file$3, 107, 0, 3364);
    ...
    function create_default_slot$1(ctx) {
    	...
    	var if_block1 = (ctx.$showSettings) && create_if_block(ctx);
