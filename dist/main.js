...
(function () {
    ...
    */
    ...
    const file$3 = "src\\components\\LoadingSpinner.svelte";
    ...
    class LoadingSpinner extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (ctx.text === undefined && !('text' in props)) {
    			console.warn("<LoadingSpinner> was created without expected prop 'text'");
    		}
    	}
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx) {
    		if (ctx.$userName !== ctx.undefined && ctx.$userPic !== ctx.undefined) return create_if_block$1;
    ...
    function create_default_slot$1(ctx) {
    	...
    	var if_block2 = (ctx.$showSummary) && create_if_block$2(ctx);
